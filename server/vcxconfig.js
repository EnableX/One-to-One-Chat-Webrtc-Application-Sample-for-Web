...
vcxconfig.SERViCE={
    name: "EnableX Sample Web Chat App",                // Name of the App
...
vcxconfig.APP_ID    = "APP-ID";               // APP ID to access Server API
vcxconfig.APP_KEY   = "APP-KEY";   // APP KEY to access Server API
